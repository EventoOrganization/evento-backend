...
exports.validateCreateEventInput = validateCreateEventInput;
...
function validateCreateEventInput(body) {
    ...
    if (body.mode !== "virtual") {
        if (!body.location)
            errors.push("Missing 'location' for physical event");
    ...
    return {
        ...
        mode: body.mode,
        location: body.mode === "virtual" ? "Virtual Event" : body.location?.trim() || "",
