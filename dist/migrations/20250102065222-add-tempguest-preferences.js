...
module.exports = {
    async up(db) {
        ...
        console.log("Migration completed: Preferences added to all TempGuest documents.");
    },
    async down(db) {
        ...
        console.log("Rollback completed: Preferences removed from all TempGuest documents.");
    },
};
