...
router.post("/logout", authentication_1.authenticateJWT, authController.logout);
router.post("/forgot-password", authController.forgotPassword);
router.post("/verify-otp", authController.verifyOTP);
router.post("/reset-password", authController.resetPassword);
router.delete("/delete-account", authentication_1.authenticateJWT, authController.deleteAccount);
