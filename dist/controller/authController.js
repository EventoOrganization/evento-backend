...
exports.quickSignup = async (req, res) => {
    ...
    try {
        ...
        if (tempGuest) {
            ...
            await Models.eventModel.updateMany({ tempGuests: tempGuest._id }, {
...
exports.signup = async (req, res) => {
    ...
    try {
        ...
        if (tempGuest) {
            ...
            const updateResult = await Models.eventModel.updateMany({ tempGuests: tempGuest._id }, {
                $push: { guests: newUser._id },
            });
...
exports.verifyOTP = async (req, res) => {
    ...
    try {
        ...
        await user.save();
        return res.status(200).json({
            message: `${flowType.charAt(0).toUpperCase() + flowType.slice(1)} verified successfully.`,
            body: {
                _id: user._id,
                email: user.email,
